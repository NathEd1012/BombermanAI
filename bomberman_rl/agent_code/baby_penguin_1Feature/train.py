...
from .callbacks import state_to_features, ACTIONS, NEW_DISTANCE_T, OLD_DISTANCE_T, PRINT
...
def custom_rewards(self, old_game_state, self_action, new_game_state, events, new_features):
...
def game_events_occurred(self, old_game_state, self_action, new_game_state, events):
    ...
    #LEARNING_RATE = initial_learning_rate * (decay_rate ** self.round_counter)
    ...
    custom_rewards(self, old_game_state, self_action, new_game_state, events, new_features)
